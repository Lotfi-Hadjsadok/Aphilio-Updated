# SaaS Ad Creative Template Prompts

> Adapted from the ecommerce ad creative system. Physical products are replaced with UI screenshots, dashboards, mockups, and workflow results. "Product shots" become screen recordings stills, browser frames, or device mockups. Social proof shifts from physical transformation to time saved, revenue gained, and workflow unlocked.

---

## **1. Headline**

🏷️ Tests text rendering with a software UI as the visual anchor.
...
🏷️ The conversion driver. Test your trial or plan offer.
...
🏷️ Real outcomes in real words. Tests emotional resonance with result-driven quotes.
...
🏷️ Diagram-style layout annotating the live product UI.
...
🏷️ Split composition. Dashboard left, benefit list right.
...
🏷️ User count + review card + press logos. The SaaS trust stack.
...
🏷️ Side-by-side comparison. Feature gap IS the argument.
...
🏷️ Messy workflow → clean SaaS output. Must feel like a genuine user story.
...
🏷️ Fake one-star SaaS review that's actually a rave. Scroll-stopper.
...
🏷️ Authority play. TechCrunch front-page energy.
...
🏷️ Emotional quote headline over a truncated G2/Capterra-style review card. The "...Read more" creates an open loop.
...
## **12. Dashboard Hero + Stat Callouts**

🏷️ The product UI is the hero. Metrics orbit it like planets. Scannable in under 2 seconds.
...
## **13. Plan / Pricing Showcase + Benefit Bar**

🏷️ Sells the platform, not just the features. Open plan card is the hero. Benefit bar handles the "what's in it for me."
...
## **14. Social Comment Screenshot + UI**

🏷️ Screenshotted tweet or LinkedIn comment = instant credibility. Looks organic.
...
## **15. Curiosity Gap / Hook Quote Testimonial**

🏷️ The bait-and-switch testimonial. Provocative headline forces the double-take. The reveal reframes it.
...
## **16. Verified Review Card (G2 / Capterra Style)**

🏷️ Mimics real review platform UI. The verified badge and helpfulness count do the trust-building.
...
## **17. Stat Callout Lifestyle (Data-Driven Workspace)**

🏷️ Same stat-radial format but lifestyle workspace photo and device sell the experience.
...
## **18. Highlighted / Annotated Testimonial**

🏷️ The highlighter pen does the work. Long-form review with key phrases visually emphasized.
...
## **19. Advertorial / Editorial Content Card**

🏷️ Looks like a tech blog post, not an ad. Editorial framing creates authority. Blends into the feed.
...
## **20. Bold Statement / Reaction Headline**

🏷️ Pure brand energy. No stats. No reviews. Just a provocative line, a hot gradient, and the UI.
...
## **21. ROI Story / "Saved X Hours"**

🏷️ Flavor-story equivalent for SaaS. The result is the hook. The product is the payoff.
...
## **22. Long-Form Manifesto / Letter Ad**

🏷️ Copy-dominant. The writing IS the ad. No product photo needed.
...
## **23. Product + Comment Callout (Faux Social Proof)**

🏷️ Facebook/LinkedIn-style comment card beneath the product UI. Organic-looking.
...
## **24. Us vs Them Color Split**

🏷️ Side-by-side feature comparison with product energy on one side.
...
## **25. Stat Callout (Data-Driven Lifestyle)**

🏷️ Statistic IS the headline. Lifestyle workspace image grounds it in reality.
...
## **26. Feature Checklist Showcase (Split UI + Info)**

🏷️ Information-dense feature ad. Screenshot left, checklist right.
...
## **27. Feature Arrow Callout / UI Annotation**

🏷️ Annotated product screenshot. Arrows point to specific UI elements.
...
## **28. UGC + Viral Post Overlay**

🏷️ Reddit or Twitter reaction screenshot over a candid lifestyle photo. Looks completely native.
...
## **29. Hero Statement + Icon Benefit Bar**

🏷️ Power statement at the top, lifestyle in the middle, icon triptych at the bottom.
...
## **30. Comparison Grid / Table**

🏷️ Feature matrix. Meme-format side-by-side. Copy contrast does all the work.
...
## **31. UGC Story Callout / Text Bubble Explainer**

🏷️ Instagram Story aesthetic. Person using the product with floating text bubbles.
...
## **32. Faux Press / News Article Screenshot**

🏷️ Looks like a real tech media article. No ad layout. Editorial authority.
...
## **33. Faux Mobile App / Dashboard Screenshot**

🏷️ Looks like a real app or browser screen. The UI IS the proof.
...
## **34. Hero Dashboard Showcase + Stat Bar**

🏷️ The UI is the hero. Stats anchor the value. CTA button in the frame.
...
## **35. Whiteboard Workflow Before / After**

🏷️ Hand-drawn whiteboard shows the transformation. Real person anchors it.
...
## **36. Hero Statement + Offer Burst (Promo Variant)**

🏷️ Moody product hero with a neon deal badge. Benefit bar below. Promo ticker at the bottom.
...
## **37. UGC Lifestyle + Review Card (Split)**

🏷️ Person in their natural environment left, brand color + product + review right.
...
## **38. Curiosity Gap + Scroll-Stopper Hook**

🏷️ No product. No brand. Just a provocative truncated caption and a visual that earns the click.
...
## **39. Native / Sticky Note Style (Screen Hero)**

🏷️ Found-photo energy. The sticky note IS the copy. The screen is the product.
